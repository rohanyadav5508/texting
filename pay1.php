...
<script type="text/javascript">
    function pay_now(){
          ...
          var actual_amount = '<?php if (isset ($_SESSION['actual_amount'])) echo $_SESSION['actual_amount'] ?>';
          //var description = $('#description').val();
          //var actual_amount = amount;
          var options = {
            "key": "rzp_test_s4s4AjHYMWSyeI", // Enter the Key ID generated from the Dashboard
            "amount": '<?php if (isset ($_SESSION['actual_amount'])) echo $_SESSION['actual_amount'] ?>', // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
            "currency": "INR",
            "name": "Charity",
            "description": "Payment to Charity",
            "image": "razorpay.png",
            "order_id": '<?php if (isset ($_SESSION['razorpay_order_id'])) echo $_SESSION['razorpay_order_id'] ?>', //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
