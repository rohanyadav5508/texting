                ...
                <div class="col-md-12">
                    <div class="about_img">
                     <h1 class="about_env">Causes</h1>
                      ...
                      <a href="pages.php" class="pages_about"><span>About us</span></a>
                        <a href="about.php" class="about_about"><span >Gallery</span></a>
                        </div>
...
$view="select * from addblog where id='$id'";
...
while($v=mysqli_fetch_array($res)){
    ...
    <div class='col-md-3 '>
     ...
     data-aos-duration='2000' class='images1'/>
                         <div class='first4_causes' data-aos='flip-right'
     data-aos-easing='ease-out-cubic'
     data-aos-duration='2000'>
                            <p class='first2'>".$v['title']."</p>
                            <h6 class='date1'>".$v['date']."</h6>
                                <p class='today'> ".$v['massage']."   
                                </p>
                             </p>
